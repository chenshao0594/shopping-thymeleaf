...
public class QPaymentConfiguration extends EntityPathBase<PaymentConfiguration> {
    ...
    private static final long serialVersionUID = 1802553950L;
    ...
    public final EnumPath<com.shoppay.core.enumeration.PaymentEnvEnum> envType = createEnum("envType", com.shoppay.core.enumeration.PaymentEnvEnum.class);

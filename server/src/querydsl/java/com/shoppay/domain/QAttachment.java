...
public class QAttachment extends EntityPathBase<Attachment> {
    ...
    private static final long serialVersionUID = -982486652L;

    public static final QAttachment attachment = new QAttachment("attachment");

    public final EnumPath<com.shoppay.attachment.common.AttachmentEnum> attachmentType = createEnum("attachmentType", com.shoppay.attachment.common.AttachmentEnum.class);

...
public class QSalesOrder extends EntityPathBase<SalesOrder> {
    ...
    private static final long serialVersionUID = -2003040291L;
    ...
    public final com.smart.shopping.core.common.QDelivery delivery;
    ...
    public final com.smart.shopping.domain.QMerchantStore merchant;
    ...
    public QSalesOrder(Class<? extends SalesOrder> type, PathMetadata metadata, PathInits inits) {
        ...
        this.billing = inits.isInitialized("billing") ? new com.smart.shopping.core.common.QBilling(forProperty("billing"), inits.get("billing")) : null;
        this.delivery = inits.isInitialized("delivery") ? new com.smart.shopping.core.common.QDelivery(forProperty("delivery"), inits.get("delivery")) : null;
        this.merchant = inits.isInitialized("merchant") ? new com.smart.shopping.domain.QMerchantStore(forProperty("merchant"), inits.get("merchant")) : null;
    }

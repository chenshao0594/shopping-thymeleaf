...
public class QMerchantStore extends EntityPathBase<MerchantStore> {
    ...
    private static final long serialVersionUID = 639167907L;
    ...
    public QMerchantStore(Class<? extends MerchantStore> type, PathMetadata metadata, PathInits inits) {
        ...
        this.country = inits.isInitialized("country") ? new com.smart.shopping.core.common.QCountry(forProperty("country")) : null;
        this.zone = inits.isInitialized("zone") ? new com.smart.shopping.core.common.QZone(forProperty("zone"), inits.get("zone")) : null;
    }

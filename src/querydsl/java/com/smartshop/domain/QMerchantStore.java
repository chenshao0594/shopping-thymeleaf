...
public class QMerchantStore extends EntityPathBase<MerchantStore> {
    ...
    private static final long serialVersionUID = -898669429L;
    ...
    public final com.smartshop.core.common.QCountry country;
    ...
    public QMerchantStore(Class<? extends MerchantStore> type, PathMetadata metadata, PathInits inits) {
        ...
        this.country = inits.isInitialized("country") ? new com.smartshop.core.common.QCountry(forProperty("country")) : null;
        this.zone = inits.isInitialized("zone") ? new com.smartshop.core.common.QZone(forProperty("zone"), inits.get("zone")) : null;
    }

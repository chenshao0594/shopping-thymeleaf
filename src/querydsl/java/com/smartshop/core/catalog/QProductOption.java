...
public class QProductOption extends EntityPathBase<ProductOption> {
    ...
    private static final long serialVersionUID = -194584740L;
    ...
    public final EnumPath<com.smartshop.core.enumeration.ProductOptionEnum> type = createEnum("type", com.smartshop.core.enumeration.ProductOptionEnum.class);

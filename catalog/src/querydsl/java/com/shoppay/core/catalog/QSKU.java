...
public class QSKU extends EntityPathBase<SKU> {
    ...
    private static final long serialVersionUID = 1721530914L;
    ...
    public final EnumPath<com.shoppay.common.enumeration.StatusEnum> status = createEnum("status", com.shoppay.common.enumeration.StatusEnum.class);

package com.shoppay.common.user;
...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -1836557260L;

    public static final QUser user = new QUser("user");

    public final com.shoppay.common.domain.QAbstractAuditingEntity _super = new com.shoppay.common.domain.QAbstractAuditingEntity(this);
